...
/**
 * Defines the props for all icon components.
 * They can accept any standard SVG element attributes.
 */
interface IconProps extends React.SVGProps<SVGSVGElement> {}

/**
 * A collection of SVG icon components for use throughout the application.
 * Each component is a React functional component that renders an SVG element.
 */
